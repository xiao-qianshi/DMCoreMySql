...
$(function ($) {
    ...
    $("#nav-col").find("span.name").text(top.clients.user.UserName);
    $("#header-nav").find("span.hiddenjkl-xs").text(top.clients.user.UserCode);

    $("#changePassword").click(function () {
        var keyValue = top.clients.user.UserId;
        var Account = top.clients.user.UserCode;
        var RealName = top.clients.user.UserName;
        $.modalOpen({
            id: "Password",
            title: 'Password',

...
namespace Dmt.DM.Code
{
    public partial class Ext
    {
        ...
        public static void CutForSquare(string sourceFilePath, string fileSaveUrl, int side, int quality)
        {
            //原始图片（获取原始图片创建对象，并使用流中嵌入的颜色管理信息） 
            System.Drawing.Image initImage = System.Drawing.Image.FromFile(sourceFilePath, true);
        ...
        //    initImage.Dispose();
        //}
        public static void CutForCustom(string sourceFilePath, string fileSaveUrl, int maxWidth, int maxHeight, int quality)
        {
            //从文件获取原始图片，并使用流中嵌入的颜色管理信息 
            System.Drawing.Image initImage = System.Drawing.Image.FromFile(sourceFilePath, true);
            ...
            else
            {
                ...
                //原图与模版比例相等，直接缩放 
                if (Math.Abs(templateRate - initRate) < 0.01)
                {
                    //按模版大小生成最终图片 
                    System.Drawing.Image templateImage = new System.Drawing.Bitmap(maxWidth, maxHeight);
                    System.Drawing.Graphics templateG = System.Drawing.Graphics.FromImage(templateImage);
        ...
        //    }
        //}
        public static void ZoomAuto(string sourceFilePath, string savePath, System.Double targetWidth, System.Double targetHeight, string watermarkText, string watermarkImage)
        {
            ////创建目录 
            //string dir = Path.GetDirectoryName(savePath);
            //if (!Directory.Exists(dir))

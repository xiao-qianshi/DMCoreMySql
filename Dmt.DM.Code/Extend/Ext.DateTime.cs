...
namespace Dmt.DM.Code
{
    public static partial class Ext
    {
        ...
        /// <returns></returns>
        public static string ToTimeString(this DateTime dateTime, bool isRemoveSecond = false)
        {
            if (isRemoveSecond) return dateTime.ToString("HH:mm");
        ...
        public static string ToTimeString(this DateTime? dateTime, bool isRemoveSecond = false)
        {
            if (dateTime == null)
                return string.Empty;
            return ToTimeString(dateTime.Value, isRemoveSecond);
        }

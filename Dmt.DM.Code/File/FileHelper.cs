...
namespace Dmt.DM.Code
{
    public class FileHelper
    {
        ...
        /// </summary>
        /// <param name="directoryPath">指定目录的绝对路径</param>        
        public static string[] GetFileNamesWithoutPath(string directoryPath)
        {
            //如果目录不存在，则抛出异常
            if (!IsExistDirectory(directoryPath))
            {
            ...
            if(files.Length > 0)
            {
                ...
                {
                    newFiles[i] = Path.GetFileName(files[i]);
                }
                return newFiles;
            }
            return files;
        ...
        public static void CreateDir(string dir)
        {
            ...
            if (!Directory.Exists(AppConsts.AppRootPath + "\\" + dir))
                Directory.CreateDirectory(AppConsts.AppRootPath + "\\" + dir);
        }
        #endregion
        ...
        public static void DeleteDir(string dir)
        {
            if (dir.Length == 0) return;
            if (Directory.Exists(AppConsts.AppRootPath + "\\" + dir))
                Directory.Delete(AppConsts.AppRootPath + "\\" + dir);
        }
        #endregion
        ...
        {
            if (File.Exists(AppConsts.AppRootPath + file))
            {
                File.Delete(AppConsts.AppRootPath + file);
            }
        }
        #endregion
        ...
        public static void CreateFile(string dir, string pagestr)
        {
            ...
            StreamWriter sw = new StreamWriter(AppConsts.AppRootPath + "\\" + dir, false, System.Text.Encoding.GetEncoding("GB2312"));
            sw.Write(pagestr);
            sw.Close();
        }
        /// <summary>
        ...
        public static void MoveFile(string dir1, string dir2 ,bool isRelativePath = true)
        {
            dir1 = dir1.Replace("/", "\\");
            dir2 = dir2.Replace("/", "\\");
            if (isRelativePath)
            {
                if (File.Exists(AppConsts.AppRootPath + "\\" + dir1))
                    File.Move(AppConsts.AppRootPath + "\\" + dir1, AppConsts.AppRootPath + "\\" + dir2);
            }
            else
            {
                File.Move(dir1, dir2);
        ...
        public static void CopyFile(string dir1, string dir2)
        {
            ...
            if (File.Exists(AppConsts.AppRootPath + "\\" + dir1))
            {
                File.Copy(AppConsts.AppRootPath + "\\" + dir1, AppConsts.AppRootPath + "\\" + dir2, true);
            }
        }

        public static void CopyFile(string dir1, string dir2,bool isRootPath)
        {

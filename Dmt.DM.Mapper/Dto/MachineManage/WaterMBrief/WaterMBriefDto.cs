...
{
    public class WaterMBriefDto
    {
        public string F_RecordDate { get; set; }
        ...
        public string F_Value15 { get; set; }
        public string F_Value16 { get; set; }
        public string F_Value17 { get; set; }
        public string F_Value18 { get; set; }
